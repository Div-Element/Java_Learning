...
\documentclass{../../../../base/fancyslides}
...
\newcommand{\basedir}{../../../../base/}
\newcommand{\imgmetal}{\basedir images/metalbg.png}
\newcommand{\imgstone}{\basedir images/bluestone.png}
...
\newcommand{\titlephrase}{Java Basics \& Concepts} % Presentation title
\newcommand{\name}{Nicholas `Timethor` Rich} % Presenter's name
\newcommand{\affil}{Div-Element} % Presenter's institution
\newcommand{\email}{nick@div-element.com} % Presenter's email address
...
\fbckg{\imgstone} % Slide background image
\begin{frame}
...
\fbckg{\imgmetal} % Slide background image
\begin{frame}
...
\begin{figure}[h]
\includegraphics[width=0.4\linewidth]{\basedir images/placeholder}
\end{figure}
}
\end{frame}
...
\fbckg{\basedir images/blank} % A blank background can be used instead of an image
\begin{frame}
...
\includegraphics[scale=0.048]{\basedir images/1.jpg} \ flickr/lovelornpoets\\
\includegraphics[scale=0.2]{\basedir images/2.jpg} \ flickr/apsmuseum
}
\end{frame}
