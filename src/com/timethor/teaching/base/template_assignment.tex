...
\newcommand{\hmwkTitle}{Assignment Template} % Assignment title
...
\homeworkSection{Testing}
Listing \ref{template_code} shows a Java script.

\Java{template_code}{And Example of Java Code Listing}
...
%\problemAnswer{
%\begin{center}
%\includegraphics[width=0.75\columnwidth]{template_figure} % Example image
%\end{center}
%
%\lipsum[3-5]
%}
